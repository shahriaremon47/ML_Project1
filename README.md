...
- first_ml_project.html: HTML export of the notebook for easy viewing.

Instructions:
- Open .html in a browser for a static view.
- Run .ipynb in Jupyter Notebook to execute code.
- CSV file contains predictions for test.csv.
